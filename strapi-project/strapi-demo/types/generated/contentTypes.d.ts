...
export interface ApiEstateEstate extends Schema.CollectionType {
  ...
  attributes: {
    textshorttext: Attribute.String &
      Attribute.Required &
      Attribute.Unique &
    ...
    textfordesclongtext: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    privatetextforpsswrd: Attribute.String &
      Attribute.Required &
      Attribute.Private &
      Attribute.SetPluginOptions<{
        i18n: {
    ...
    enum: Attribute.Enumeration<['male', 'female']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
